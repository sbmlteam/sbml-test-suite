...
{
    OnlineSTS.logError("Null sessionResults");
}

// We have our resultsID identifier and the session results map.
// Get the test results for this particular invocation in this session.
