...
The model contains one events, that assign value both species S1 and S4, defined as:

[{width:30em,margin-left:5em}|        | Trigger    | Delay | Assignments |
 | Event1 | $S2 < S4$ | $1.75$   | $S1 -> 2 \x 10^-15$    |]
 |  |  |   | $S3 -> 0.5 \x 10^-15$    |]
...
addEvent[ trigger -> S2 < S4, delay->1.75, eventAssignment -> {S1->2 10^-15, S3->5 10^-16}  ];
