...
You can use the sample files in this collection as test input into your
SBML-compliant software.  Documentation is rather sparse at the moment, so
it is necessary to deduce the purposes of the individual models from the
comments in the files themselves, and occassionally from their directory
