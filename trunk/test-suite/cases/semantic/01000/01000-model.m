...
| _E0 | $geq(time, 0.5)$ | (unset) | true | true | Trigger time | $0$ | $k4 = 0$ |
...
| _E6 | $and(geq(time, 1), leq(time, 4))$ | (unset) | true | true | Trigger time | $5$ | $k4 = 0$ |
...
| Initial value of parameter k1 | $avogadro$ | constant |
