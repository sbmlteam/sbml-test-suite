...
componentTags: StoichiometryMath, Compartment, Species, Reaction, Parameter, RateRule, EventNoDelay 
...
addReaction[reactants->{S1}, products->{S2}, reactantStoichiometry->{4 * p1}, 
       reversible -> False,
	     kineticLaw -> k1 * S1 * C ];
