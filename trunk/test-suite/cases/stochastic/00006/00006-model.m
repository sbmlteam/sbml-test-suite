...
category:        Test
synopsis:        Basic two-reaction system with boundary species
componentTags:   Compartment, Parameter, Reaction, Species
testTags:        Amount, BoundaryCondition, HasOnlySubstanceUnits, NonUnityStoichiometry
testType:        StochasticTimeCourse
levels:          2.1, 2.2, 2.3, 2.4, 3.1
generatedBy:     Analytic
packagesPresent: 

This reaction system is identical to test 00001, but with the addition of a boundary species 'Sink'.
