//
// @file CocoaUIEnhancer.java
// @brief CocoaUIEnhancer class for integrating with Cocoa
...
public class CocoaUIEnhancer
{
    ...
    {
        final org.eclipse.swt.widgets.Listener about;
        final Listener                         pref;
        ...
        public long actionProc(long id, long sel, long arg0)
        {
            ...
            {
                if (about != null) about.handleEvent(null);

            }
            else if (sel == sel_preferencesMenuItemSelected_)
            {
                if (pref != null) pref.handleEvent(null);
            }
            else
            {
                // Unknown selection!
     ...
     *            About and Quit menu
     *            items. If you do not wish to customize the About and Quit menu
     *            items, just pass <tt>null</tt> here.
     */
                                    ...
                                    Listener preferencesAction)
    {
        ...
        MenuHookObject target = new MenuHookObject(aboutAction,
                                                   preferencesAction);
        ...
        throws Exception
    {
        ...
        invoke(osCls, "class_addMethod", new Object[] {wrapPointer(cls),
            ...
            "@:@"}); //$NON-NLS-1$
        invoke(osCls, "class_addMethod", new Object[] {wrapPointer(cls),
            wrapPointer(sel_aboutMenuItemSelected_), wrapPointer(proc3), "@:@"}); //$NON-NLS-1$
        ...
        Object aboutMenuItem = invoke(nsmenuCls,
                                      appMenu,
                                      "itemAtIndex",
        ...
        if (appName != null)
        {
            Object quitMenuItem = invoke(nsmenuCls,
                                         appMenu,
                                         "itemAtIndex",
        ...
        Object prefMenuItem = invoke(nsmenuCls,
                                     appMenu,
                                     "itemAtIndex",
