...
public:
  ...
  const std::string& getNewFilename() const { return mNewFilename;  }
  const std::string& getDirectory () const { return mDirectory; }
  
  std::string getFullname () const;

  unsigned int  getConstraintId     () const;
  std::string   getConstraintIdString() const;
  static std::string   getConstraintIdString(int id);
...
private:
  ...
  unsigned int mConstraintId;
  unsigned int mSequenceId;
  unsigned int mNumFailures;
  unsigned int mAdditionalFailId;
};
