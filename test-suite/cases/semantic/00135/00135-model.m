...
initial value of the species is explicitly declared, but conflicts with the result 
of the initialAssignment.  The result of the initialAssignment should be used.


The initial conditions are as follows:
[|                                  ||          Value  || Units                     |
|              Initial amount of S1:|| $1.125 \x 10^-15$ || mole                      |
...
addSpecies[ S1, initialAmount->1.125 10^-15 ];
