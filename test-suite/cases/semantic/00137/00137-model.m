...
The model contains one compartment named compartment.
  There are three species named S1, S2 and S and two parameters named k1 and k2.
...
[|| Type || Variable || Formula |
 || Assignment || S3 || $1*S2$  |]
In this case the initial value for species S3 must be calculated by the assignmentRule.  
Note that since this assignmentRule 
