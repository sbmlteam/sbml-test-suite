...
initial value of the parameter is explicitly declared, and is consistent with the result 
...
addParameter[ k2, value -> 0.25, constant -> False ];
addParameter[ p1, value -> 0.125 ];
addInitialAssignment[ k2, math -> p1*2];
