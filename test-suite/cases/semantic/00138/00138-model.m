...
[{width:30em,margin-left:5em}|  *Type*  |  *Variable*  |  *Formula*  |
 | Assignment | S3 | $1 * S2$  |]
In this case the initial value declared for species S3 is consistent with the value
calculated by the assignmentRule.  Note that since this assignmentRule 
