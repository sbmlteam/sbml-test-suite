...
testTags:      InitialAmount, BoundaryCondition, ConstantSpecies
testType:      TimeCourse
levels:        2.1, 2.2, 2.3

The model contains one compartment named compartment.
  There are four species named S1, S2, S3 and S4 and three parameters named k1, k2 and k3.
  Species S2 is labeled as constant and therefore cannot be changed 
...
addSpecies[ S2, initialAmount -> 1.5 10^-5, boundaryCondition->True, constant -> True ];
