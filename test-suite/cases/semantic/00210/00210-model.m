...
The model contains one compartment named compartment.
  ...
  All four species are declared to have only substance units.
...
|             Value of parameter k1:|| $ 7.5 \x 10^15$ || mole^-1^ second^-1^ |
...
addSpecies[ S1, initialAmount -> 1.0 10^-15, hasOnlySubstanceUnits->True];
addSpecies[ S2, initialAmount -> 1.5 10^-15, hasOnlySubstanceUnits->True];
addSpecies[ S3, initialAmount -> 2.0 10^-15, hasOnlySubstanceUnits->True];
addSpecies[ S4, initialAmount -> 1.0 10^-15, hasOnlySubstanceUnits->True];
addParameter[ k1, value -> 7.5 10^15 ];
