...
[{width:30em,margin-left:5em}|        | Trigger    | Delay | Assignments |
 | Event1 | $S2 < S4$ | $-$   | $S1 -> 2 \x 10^-15$    |]
 | Event2 | $S3 > 2 \x 10^-15$ | $-$   | $S3 -> 1 \x 10^-15$    |]
...
addEvent[ trigger -> S2 < S4, eventAssignment -> S1->2/10^15 ];
addEvent[ trigger -> S3 > 2/(10^15), eventAssignment -> S3->1/10^15 ];
