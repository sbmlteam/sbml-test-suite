...
This model contains one 0-dimensional compartment identified as
"compartment".  There are four species, S1, S2, S3 and S4, and two
parameters, k1 and k2.

The model contains defines a function called "multiply" that takes two
numerical arguments and multiplies them:

[{width:25em,left-margin:5em}| *Id* | *Arguments* | *Formula* |
| multiply | x, y | $x * y$ |]

The model contains two reactions defined as:

[{width:25em,left-margin:5em}| *Reaction* | *Rate* |
| S1 + S2 -> S3 + S4 | $multiply(k1, multiply(S1, S2))$ |
| S3 + S4 -> S1 + S2 | $k2 * S3 * S4$                       |]

The initial conditions are as follows:

[{width:25em,left-margin:5em}||*Value*   |*Units*             |
...
In this example, the compartment has its %spatialDimensions% attribute set
to a value of zero; i.e., the compartment represents a point, and therefore
