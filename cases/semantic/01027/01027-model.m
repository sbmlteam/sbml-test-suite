...
testTags:      Amount, DefaultValue, ReversibleReaction, AssignedConstantStoichiometry, NonUnityStoichiometry
testType:      TimeCourse
levels:        2.1, 2.2, 2.3, 2.4, 2.5
generatedBy:   Numeric

Note:  This test is a copy of model 827, with the products and reactants reversed, 
