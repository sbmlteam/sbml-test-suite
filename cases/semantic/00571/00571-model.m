...
[{width:30em,margin: 1em auto}|  *Type*  |  *Variable*  |  *Formula*  |
 | Algebraic |   n/a    | $subtract(multiply((1 + k3), S1), T)$  |]

The rule applies both the functionDefinitions defined as:
...
addRule[ type->AlgebraicRule, math -> subtract[multiply[(1+k3), S1], T]];
