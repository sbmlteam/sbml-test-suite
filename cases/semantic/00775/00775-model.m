...
[{width:30em,margin: 1em auto}| | *Trigger*             | *Delay* | *Assignments* |
 ...
 | Event2                      | $S3 > 2.25 \x 10^-2$ | $0.75$  | $S4 -> 1 \x 10^-2$    |]
...
addEvent[ trigger -> S4 > S2, eventAssignment -> S1->2/10^2 ];
addEvent[ trigger -> S3 > 9/(4 10^2), delay->0.75, eventAssignment -> S4->1/10^2 ];
