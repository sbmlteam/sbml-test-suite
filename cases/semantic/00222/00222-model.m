...
testTags:      Amount, 2D-Compartment, BoundaryCondition
testType:      TimeCourse
...
addSpecies[ S3, initialAmount -> 2.0 10^-4, boundaryCondition->True];
addSpecies[ S4, initialAmount -> 1.0 10^-4, boundaryCondition->True];
