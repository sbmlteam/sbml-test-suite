...
testTags:        Amount, BoundaryCondition, EventUsesAssignmentTimeValues, InitialValueReassigned, NonConstantCompartment, NonConstantParameter, NonUnityCompartment, VolumeConcentrationRates
testType:        TimeCourse
...
| E0 | $time >= 0.45$ | Assignment time | $0.1$ | $S1 = S1 + 0.2$ |]
