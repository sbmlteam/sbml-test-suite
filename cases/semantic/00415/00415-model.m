...
synopsis:      Basic two reactions with three species in one compartment
               and one event, subject to a delay, that assigns value to a 
...
[{width:30em,margin: 1em auto}| | *Trigger*           | *Delay* | *Assignments* |
 | Event1                      | $lessthan(S1, 0.7)$ | $0.25$  | $S2 = 1.5$    |
 |                             |                     |         | $S1 = 1$      |]
...
addReaction[ S3 -> S1 + S2, reversible -> False,
	     kineticLaw -> k2 * S3 * C ];
addEvent[ trigger -> lessthan[S1, 0.7], delay->0.25, eventAssignment -> {S2->1.5, S1->1} ];
