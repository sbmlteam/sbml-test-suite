...
packagesPresent: 
 ...
 In this model, a delayed event assigns the rate of change of a parameter, from the value it has at the asignment time of the event.
...
| E0 | $time > 1.5$ | Assignment time | $2$ | $P2 = rateOf(P1)$ |]
