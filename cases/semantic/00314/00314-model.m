...
testTags:      Amount, NonConstantCompartment, NonConstantParameter, InitialValueReassigned
testType:      TimeCourse
...
addCompartment[ C, constant->False, size -> 0.1 ];
...
addRule[ type->RateRule, variable -> p2, math -> 0.2];
