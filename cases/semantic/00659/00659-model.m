...
case the value from the initialAssignment is inconsistent with the value
attributed to k1 by the model definition.  The calculated value should be used.
...
|Value of parameter k1               |$          5.0$ |mole litre^-1^            |
