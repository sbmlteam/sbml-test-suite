...
testTags:        DelayInEventAssignment, EventIsNotPersistent, InitialValueReassigned, NonConstantParameter, RandomEventExecution
testType:        TimeCourse
levels:          3.1, 3.2
...
|  |  |  |  | $Q = Q + delay(reset, 0.005) + 0.005$ |
| Rinc | $reset >= 0.01$ | $1$ | false | $reset = 0$ |
|  |  |  |  | $R = R + delay(reset, 0.005) + 0.005$ |
