...
Another possibility is that the test itself is going wrong because your program has truncated the values from which avogadro is being subtracted:  if you get the same result for 'a_truncated' as you get for 'a_2006', this probably means you're using the infix output of an older version of libsbml, which truncated all 'e-notation' values to seven significant digits, or a similar scheme that does the same thing.
