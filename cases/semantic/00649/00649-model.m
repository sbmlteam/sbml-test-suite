...
componentTags: Compartment, Species, Reaction, Parameter, RateRule, EventWithDelay 
testTags:      Amount
testType:      TimeCourse
...
addReaction[ S1 -> S2, reversible -> False,
	     kineticLaw -> k1 * S1 * C ];
addEvent[ trigger -> S1 < 0.1, delay -> 0.75, eventAssignment -> S2->1 ];
