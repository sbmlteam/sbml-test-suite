...
componentTags:   CSymbolTime, Compartment, EventWithDelay, Parameter, RateRule, Species
testTags:        Amount, EventUsesAssignmentTimeValues, HasOnlySubstanceUnits, NonConstantParameter, NonUnityCompartment
testType:        TimeCourse
...
| E1 | $time >= 2.5$ | Assignment time | $2$ | $P1 = S1 + 1$ |]
