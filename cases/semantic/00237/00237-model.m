...
addSpecies[ S2, initialAmount -> 1.5 10^-4, boundaryCondition->True];
addSpecies[ S3, initialAmount -> 2.0 10^-4];
addSpecies[ S4, initialAmount -> 1.0 10^-5, boundaryCondition->True];
addParameter[ k1, value -> 6.2 10^4 ];
addParameter[ k2, value -> 5 10^4 ];
