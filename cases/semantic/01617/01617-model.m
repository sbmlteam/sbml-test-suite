...
category:        Test
synopsis:        FBC test with initial assignment.
...
packagesPresent: fbc, fbc_v2
 ...
 In this test, fb_0 is set to zero by an initial assignment, which contradicts its 'value' attribute.  A non-strict test.
