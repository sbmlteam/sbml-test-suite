...
addSpecies[ S2, initialConcentration -> 1.0 10^-2];
addSpecies[ S3, initialConcentration -> 2.0 10^-2];
addSpecies[ S4, initialConcentration -> 1.0 10^-2, boundaryCondition->True];
