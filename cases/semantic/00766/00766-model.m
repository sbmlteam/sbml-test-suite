...
|Initial concentration of S4          |$1.0 \x 10^-3$  |mole litre^-1^                       |
...
addSpecies[ S2, initialConcentration -> 1.2 10^-3];
...
addEvent[ trigger -> S4 > S2, delay->1.2, eventAssignment -> S1->2 10^-3 ];
