...
[{width:30em,margin: 1em auto}| | *Trigger*            | *Delay* | *Assignments*       |
 | Event1                      | $S4 > S2$            | $0.5$   | $S1 -> 2 \x 10^-2$ |]
 | Event2                      | $S3 > 2.5 \x 10^-2$ | $1.5$   | $S4 -> 1 \x 10^-2$ |]
...
addEvent[ trigger -> S4 > S2, delay->0.5, eventAssignment -> S1->2 10^-2 ];
addEvent[ trigger -> S3 > 10/(4 10^2), delay->1.5, eventAssignment -> S4->1 10^-2 ];
