...
testTags:        Amount, AssignedVariableStoichiometry, EventIsNotPersistent, NonConstantParameter, NonUnityStoichiometry, SpeciesReferenceInMath
testType:        TimeCourse
levels:          3.1, 3.2
...
| E1 | $(S1_stoich >= 2.3) && (S1_stoich <= 3.3)$ | false | $2$ | $P1 = 3$ |]
