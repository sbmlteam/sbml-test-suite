...
componentTags:   AssignmentRule, CSymbolDelay, CSymbolTime, EventNoDelay, EventPriority, Parameter, RateRule
...
| Assignment | S | $Q + R$ |
| Assignment | S2 | $delay(Q, 1) + delay(R, 1)$ |
| Rate | reset | $1$ |]
...
| Initial value of parameter S2 | $delay(Q, 1) + delay(R, 1)$ | variable |
