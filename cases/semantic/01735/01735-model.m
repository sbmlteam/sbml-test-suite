...
packagesPresent: 
 ...
 In this model, a model conversion factor affects a reaction with assigned stoichiometries and assigned stoichiometries, changing the levels of S1 and S2, but not S3 and S4.
