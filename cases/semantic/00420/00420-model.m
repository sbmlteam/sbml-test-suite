...
testTags:      Amount, 2D-Compartment, EventIsPersistent
testType:      TimeCourse
...
[{width:30em,margin-left:5em}| | *Trigger*   | *Delay* | *Assignments* |
 | Event1                      | $S1 < 0.75$ | $5$     | $S2 = 1$      |
 | Event2                      | $S3 > 1.4$  | $10$    | $S1 = 1$      |]
...
addReaction[ S3 -> S1 + S2, reversible -> False,
	     kineticLaw -> k2 * S3 * C ];
addEvent[ trigger -> S1 < 0.75, delay->5, eventAssignment -> S2->1 ];
addEvent[ trigger -> S3 > 1.4, delay->10,eventAssignment -> S1->1 ];
