...
packagesPresent: 
 ...
 In this model, model and species conversion factors are set for species not reset partway through the simulation by a non-persistent event.
...
| E0 | $(S2 >= 3.07) && (S2 <= 3.095)$ | false | $1$ | $S2 = 4$ |
|  |  |  |  | $S1 = 6$ |]
