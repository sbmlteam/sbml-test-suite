...
category:        Test
synopsis:        FBC with constant assignment rule to flux bound.
...
packagesPresent: fbc, fbc_v2
 ...
 In this test, an assignment rule is used to set a flux bound to a constant value.
...
| Initial value of parameter fb_0 | $0$ | variable |]
