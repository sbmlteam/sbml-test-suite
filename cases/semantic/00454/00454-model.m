...
testTags:      NonConstantParameter, EventIsPersistent
testType:      TimeCourse
...
The model contains two events that assign values to parameters S2 and S1:

[{width:30em,margin: 1em auto}| | *Trigger*   | *Delay* | *Assignments* |
 | Event1                      | $S1 < 0.75$ | $1$     | $S2 = 1$      |
...
addEvent[ trigger -> S1 < 0.75, delay->1, eventAssignment -> S2->1 ];
