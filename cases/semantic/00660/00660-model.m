...
case there is no value attributed to k1 by the model definition.  The 
value calculated using the initialAssignment should be used.
...
|Value of parameter k1               |$ undeclared$ |mole litre^-1^            |
