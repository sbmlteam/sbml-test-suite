...
values.  In this model, the initial value for the species X0 is inconsistent
with the value calculated using the InitialAssignment.  The calculated value
should be used.

The initial conditions are as follows:

[{width:30em,margin: 1em auto}| |*Value* |*Units*  |
|Initial amount of X0          |$3$  |mole                      |
