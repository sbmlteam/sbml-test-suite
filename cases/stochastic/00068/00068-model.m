...
The model contains:
* 1 species (X)
* 4 parameters (t, rate, truncationLowerBound, truncationUpperBound)
* 1 compartment (C)

There is one event:

[{width:30em,margin: 1em auto}|  *Event*  |  *Trigger*  | *Event Assignments* |
| E0 | $t >= 0.5$ | $X = exponential(rate, truncationLowerBound, truncationUpperBound)$ |
|  |  | $t = -0.5$ |]
...
| Initial value of parameter rate | $1$ | constant |
