...
category:        Test
synopsis:        ExponentialDistribution test with a lower bound
...
Test of the ExponentialDistribution function from the 'distrib' package, with a lower inclusive bound.
...
| E0 | $t >= 0.5$ | $X = exponential(1, 0.25, INF)$ |
|  |  | $t = -0.5$ |]
