...
This model is identical to model 00001, with a more complicated reaction rate that is half the rate of 00001).
...
| Initial value of parameter Lambda | $0.2$ | constant |
