...
category:        Test
synopsis:        NormalDistribution test with upper truncation bound
...
Test of the NormalDistribution function from the 'distrib' package, with a positive upper truncation bound.
...
| E0 | $t >= 0.5$ | $X = normal(0, 1.5, -INF, 0.5)$ |
|  |  | $t = -0.5$ |]
