...
category:        Test
synopsis:        ExponentialDistribution test with an upper bound
...
Test of the ExponentialDistribution function from the 'distrib' package, with an upper inclusive bound.
...
| E0 | $t >= 0.5$ | $X = exponential(1, -INF, 0.75)$ |
|  |  | $t = -0.5$ |]
