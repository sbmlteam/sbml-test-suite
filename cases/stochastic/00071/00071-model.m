...
category:        Test
synopsis:        NormalDistribution test with lower inclusive bound
...
Test of the NormalDistribution function from the 'distrib' package with a positive lower inclusive bound.
